...
class Hopper(WalkerBase):
    ...
    def __init__(self, power=0.75):
        WalkerBase.__init__(self, "hopper.xml", "torso", action_dim=3, obs_dim=15, power=power)
...
class Walker2D(WalkerBase):
    ...
    def __init__(self, power=0.40):
        WalkerBase.__init__(self,  "walker2d.xml", "torso", action_dim=6, obs_dim=22, power=power)
...
class HalfCheetah(WalkerBase):
    ...
    def __init__(self, power=0.90):
        WalkerBase.__init__(self, "half_cheetah.xml", "torso", action_dim=6, obs_dim=26, power=power)
...
class Ant(WalkerBase):
    ...
    def __init__(self, power=2.5):
        WalkerBase.__init__(self, "ant.xml", "torso", action_dim=8, obs_dim=28, power=power)
...
class Humanoid(WalkerBase):
    ...
    def __init__(self, power=0.41):
        WalkerBase.__init__(self,  'humanoid_symmetric.xml', 'torso', action_dim=17, obs_dim=44, power=power)
