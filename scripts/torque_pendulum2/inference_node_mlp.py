...
from meta_rl_tools.nets import PolNet
...
parser.add_argument('--pol', type=str, default='pol_mlp1.pkl')
...
pol_net = PolNet(observation_space, action_space, h1=args.h_size, h2=args.h_size)
